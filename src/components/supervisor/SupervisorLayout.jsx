...
export default function SupervisorLayout() {
  ...
  const getNotificationIcon = (notification) => {
    ...
    switch (notification_type) {
      ...
      case 'shift_end_reminder':
        return <CalendarDays className="h-5 w-5 text-indigo-500" />;
  ...
  // KEEP THE EXISTING NAVIGATION ITEMS, just update icons
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link to="/supervisor" className="flex items-center gap-2">
              ...
              <div className="hidden sm:block">
                <span className="text-xl font-semibold text-gray-900">Supervisor Portal</span>
                ...
                {user?.avatar ? (
                  ...
                  <div className="w-8 h-8 bg-gradient-to-br from-blue-500 to-blue-700 rounded-full flex items-center justify-center ring-2 ring-blue-100">
                    <span className="text-white font-semibold text-sm">
                      {user?.names?.charAt(0) || user?.name?.charAt(0) || 'S'}
                    </span>
                  </div>
                )}
      ...
      <div className="flex">
        {/* Sidebar - KEEP EXISTING NAVIGATION LINKS */}
          ...
          <div className="px-4 mt-8 mb-4">
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg p-4 border border-blue-200 shadow-sm">
              ...
              <p className="text-xs text-blue-700 mb-2">
                Monitor your team's performance, manage tasks, and oversee employee activities.
              </p>
              <div className="flex items-center gap-2 text-xs text-blue-600">
